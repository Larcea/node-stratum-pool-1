...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients, poolOptions){
    ...
    // For X16RT
    if(rpcData.accumulatorhashes && rpcData.proofoffullnodehash){
        this.getJobParams = function(){
            if (!this.jobParams){
                this.jobParams = [
                    this.jobId,
                    this.prevHashReversed,
					rpcData.accumulatorhashes[10],
					rpcData.accumulatorhashes[100],
					rpcData.accumulatorhashes[1000],
					rpcData.accumulatorhashes[10000],
					rpcData.proofoffullnodehash,
